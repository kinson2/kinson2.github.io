...
- [Course Specifics](#course-specifics)  
  ...
  - [Attendance, Absence, and Missing Assignments Policy](#absence)  
...
## <a name="repo"></a>Your GitHub Repository

Successfully completing the third step in the [Software](#software) section (below) automatically (and systematically) sets up your GitHub repository for this course, which will be named fa25_stat440_netid, where netid represents your Illinois netid. You do not create this repo manually. Your repository is where you will submit assignments and where you will see grades for assignments. Your repository has a main branch, where you will create directories corresponding to the assignments. The Instructor will systematically create additional branches corresponding to updates to your grades for that week, e.g., a branch named grades_week01 would contain grades for assignments that were due and graded during the first week of class.
...
- Typically, Mondays will serve as initial assessment days including training labs. Wednesdays will be lecture and review days. Fridays will be assessment days including test labs and paper exams.
...
- **Instructor office hours**: 
  ...
  - Thursdays 06:00 pm - 07:00 pm in [Zoom using this link](https://illinois.zoom.us/j/81789841304?pwd=ausPE8iWFRceRD18UY313bDFBHAfSt.1)
...
:--|:--|:--|:--
01 | 08/25 - 08/31 | Introduce the course and software, Git and GitHub tips, GitHub Copilot quick tutorial, Autograder pitfall examples | training-lab01 (Monday 08/25), test-lab01 (Friday 08/29)
02 | 09/01 - 09/07 | Structures of data, delimiters, and file extensions, Using the pipe operator `%>%`, Handling dates and times, Exporting data | training-lab02 (Wednesday 09/03), test-lab02 (Friday 09/05), homework01 (Friday 09/05)
03 | 09/08 - 09/14 | Accessing and importing data (including web scraping and APIs) | training-lab03 (Monday 09/08), test-lab03 (Friday 09/12)
04 | 09/15 - 09/21 | Shiny apps and dashboards | training-lab04 (Monday 09/15), test-lab04 (Friday 09/19), homework02 (Friday 09/19)
05 | 09/22 - 09/28 | Data visualization I | training-lab05 (Monday 09/22), paper-exam01 (Friday 09/26)
06 | 09/29 - 10/05 | Data visualization II | training-lab06 (Monday 09/29), test-lab05 (Friday 10/03), homework03 (Friday 10/03)
07 | 10/06 - 10/12 | Arranging data, Data reduction | training-lab07 (Monday 10/06), test-lab06 (Friday 10/10), 
08 | 10/13 - 10/19 | Reshaping data, Data expansion | training-lab08 (Monday 10/13), test-lab07 (Friday 10/17), homework04 (Friday 10/17)
09 | 10/20 - 10/26 | Regular expression, String manipulation | training-lab09 (Monday 10/20), paper-exam02 (Friday 10/24)
10 | 10/27 - 11/02 | Summarizing data | training-lab10 (Monday 10/27), test-lab08 (Friday 10/31), homework05 (Friday 10/31)
11 | 11/03 - 11/09 | Combining data | training-lab11 (Monday 11/03), test-lab09 (Friday 11/07), 
12 | 11/10 - 11/16 | SQL databases and queries | training-lab12 (Monday 11/10), test-lab10 (Friday 11/14), homework06 (Friday 11/14)
13 | 11/17 - 11/23 | SQL queries and sub-queries | training-lab13 (Monday 11/17), paper-exam03 (Friday 11/21)
14 | 11/24 - 11/30 | FALL BREAK |
15 | 12/01 - 12/07 | Creative thinking, critical thinking, and futurism in data science | training-lab14 (Monday 12/01), reflective-survey (Friday 12/05)
...
### <a name="grades"></a>Your Grades

The grades branch of your GitHub repo is where you will find your grades for any assignments that have been graded by that week. As mentioned in the [Your GitHub Repository](#repo) section above, the Instructor will systematically create additional branches corresponding to updates to your grades for that week, e.g., a branch named grades_week01 would contain grades for assignments that were due and graded during the first week of class. Students can expect grades to be returned weekly and possibly even more frequently, especially if graded by the autograder.
...
This [discussion board](https://github.com/illinois-stat440/course_content/discussions), which exists as a tab on the **course_content** repository, is one of the best ways to communicate with classmates and the Instructor. Questions can be seen quickly and receive a rapid response. Students are encouraged to use this board, but there is no requirement to participate in the discussion board.

Do use the board to openly discuss ideas about the course such as questions about content, deadlines, notes, data, etc. If a student specifically wants the Instructor to respond, then student should use the mention `@kinson2` when posting in the board. The things discussed here should be of a non-personal and non-private matter. If student has a personal or private matter to discuss with the Instructor, please send an email to kinson2@illinois.edu. Additionally, the conversation in the discussion board should be respectful of people's differences and cannot be used to speak negatively about anyone or harm anyone. 
...
The Instructor will use the Discussions board to make course announcements, including but not limited to, grades being posted, changes or updates to assignments, notes, and other materials, changes that affect the whole course, such as switching to online due to sickness, etc..
...
The reflective survey is a short digital survey that students complete near the end of the semester. The survey will ask students to reflect on their learning in the course, what they liked, what they did not like, specific aspects of technology usage, and how the course might be improved. The survey is worth 2 points and is due on Friday of Week 15 (December 5, 2025). See the [Calendar](#calendar) above for deadline(s) or due date(s).

**Final Project**

The final project is a shiny app that students create in R and demonstrate in a video presentation. The project is worth 22 points total (12 points for the video presentation and 10 points for the app). The project is due on Friday of Week 16 (December 12, 2025). Students must submit the .R script file in their repo and include a URL/link to the video presentation within the .R script file as a code comment using the `#` symbol. The video must be between 5 and 10 minutes long and show the student's face in full view while explaining what purpose the app serves if it were to be used by people later in the data pipeline such as analysts and data scientists, how the app works, why they chose to build it, and how they personally connect with the app. See the [Calendar](#calendar) above for deadline(s) or due date(s).

**Paper Exam**

The paper exam is an in-person exam that will be given on some Fridays. The exam will be closed notes, closed book. See the [Calendar](#calendar) above for deadline(s) or due date(s).

**Homework**

These are assignments that students complete individually and submit in the main branch of their GitHub repository inside of the **homework** directory. The submitted assignment must follow reproducibility guidelines and must not contain executable errors or warnings. See the [Calendar](#calendar) above for deadline(s) or due date(s).

**Test Lab**

These are in-person lab sessions that are due at the end of the class period on some Fridays. Test labs are intended to challenge students in a short period of time to apply covered concepts for the week cumulatively. See the [Calendar](#calendar) above for deadline(s) or due date(s).

**Training Lab**

These are in-person lab sessions that are due at the end of the class period on Mondays. Training labs are intended to give students an opportunity to fail productively such that accurate knowledge of content and skills may be corrected and reinforced. See the [Calendar](#calendar) above for deadline(s) or due date(s).
...
## <a name="absence"></a>Attendance, Absence, and Missing Assignments Policy

Students are expected and required to attend class each day it meets. 

Students are allowed 3 excused absences. If a student's absence is on a day that any assignment is due and the absence gets excused, then the student must submit all missed assignment(s) by Wednesday of the following week. 

For an absence to be excused and make up work to be accepted, the student must provide an explanation to the instructor within 48 hours of absence and supply supporting evidence as required by the instructor, which may include a doctor's note, hospital admission document, or an [absence letter](https://studentcode.illinois.edu/article1/part5/1-501) from the Connie Frank CARE Center in the Office of the Dean of Students. 

Absences beyond 3 days will not be excused nor will any missing assignment(s) be accepted/graded.

Students who do not attend class on a day that an assignment is due and do not have an excused absence will receive a grade of 0 for any such missed assignment.
