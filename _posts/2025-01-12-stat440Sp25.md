---
layout: post
title: "STAT 440 Spring 2025 Unofficial Syllabus"
...
- For section 1UG/GR, the class meets at 03:00 pm - 03:50 pm in Room 32 of the Psychology Building on Mondays, Wednesdays, and Fridays.

- For section 2UG/GR, the class meets at 04:00 pm - 04:50 pm in Room 32 of the Psychology Building on Mondays, Wednesdays, and Fridays.
...
Office hours will be in-person. If a student has a specific question, but cannot attend the office hours, then that student should post their question in the discussion board (see Discussions tab of the **course_content** repo). If a student wants one-on-one assistance from the course staff at an alternative time, then that student should email the course staff in order to schedule a Zoom meeting. 

- **Instructor in-person office hours**: 

  - Thursdays 06:00 pm - 07:00 pm in Zoom using the link [https://illinois.zoom.us/j/87352243117?pwd=ZhyncDW9V4b7R7o1auhauqDRKlJ7m9.1](https://illinois.zoom.us/j/87352243117?pwd=ZhyncDW9V4b7R7o1auhauqDRKlJ7m9.1)
...
**R**  
  ...
  - R for Data Science. Wickham and Grolemund. O'Reilly Media, Inc. https://r4ds.hadley.nz/ 
...
- **Git and GitHub**  
  ...
  - [Step 3. Click here to enroll in STAT 440 course organization and follow the steps to be setup properly in the learning management system](https://edu.cs.illinois.edu/create-gh-repo/sp25_stat440)
...
Week | 2025 Dates | Topics Covered |
:--|:--|:--|
01 | 01/20 - 01/24 | Introduce the course and software - RStudio, RMarkdown, Git, and GitHub, Git and GitHub tips, Autograder pitfall examples |
02 | 01/27 - 01/31 | Autograder pitfall examples, Git and GitHub tips, Loops and conditional execution, Apply family of functions, Vectorization |
03 | 02/03 - 02/07 | What is data, Structures of data, delimiters, and file extensions, Accessing and importing data, Exporting data, Handling dates and times |
04 | 02/10 - 02/14 | Assigning objects, Arranging data, Reshaping data, Data expansion, Data reduction |
05 | 02/17 - 02/21 | Regular expression and string manipulation, Summarizing data, Combining data |
06 | 02/24 - 02/28 | Data visualization using tidyverse |
07 | 03/03 - 03/07 | SQL queries and sub-queries |
08 | 03/10 - 03/14 | **Midterm Exam 01 on Wednesday March 12**, **Reassessment for Midterm Exam 01 on Friday March 14**, Focus on Midterm Exam 
09 | 03/17 - 03/21 | **SPRING BREAK (no class or office hour)** |
10 | 03/24 - 03/28 | Validating data, Cleaning data using tidyverse |
11 | 03/31 - 04/04 | Accessing and importing data via web scraping, Accessing and importing data via an API |
12 | 04/07 - 04/11 | Data exploration using curiosity and creativity exercises |
13 | 04/14 - 04/18 | Shiny apps and dashboards |
14 | 04/21 - 04/25 | **Midterm Exam 02 on Wednesday April 23**, **Reassessment for Midterm Exam 02 on Friday April 25**, Focus on Midterm Exam |
15 | 04/28 - 05/02 | Interview with a data worker, Data workers and responsibilities, Discussion about careers, graduate school, and the future post-STAT440, Focus on Final Exam |
16 | 05/05 - 05/09 | **READING DAY - May 08 (no more classes or office hours)**, Interview with a data worker, Data workers and responsibilities, Discussion about careers, graduate school, and the future post-STAT440, Focus on Final Exam |
17 | 05/12 - 05/16 | **Final Exam for section 1 UG/GR at 8:00 am - 11:00 am on Monday May 12**, **Final Exam for section 2 UG/GR at 1:30 pm - 4:30 pm on Wednesday May 14** |

### <a name="grading-breakdown"></a>Grading Breakdown

**12 Piloted Practice Assignments: 12 points total (1 point each)**  

  - pp01-pp16 are weekly comprehensive assignments due on Mondays (before class starts). No student receives credit for pp01, pp02, pp03, and pp09. Credit is earned for pp04-pp16, excluding pp09.
  
**2 Lab Assignments: 8 points total (4 points each)**  

  - Lab01 series begins Week 04 (February 12) and ends Week 07 (March 07). Each student will be an in-person in-class driver only once in this series. Labs take place on Wednesdays and Fridays in this series.  
  - Lab02 series begins Week 10 (March 26) and ends Week 13 (April 18). Each student will be an in-person in-class driver only once in this series. Labs take place on Wednesdays and Fridays in this series.

**2 Midterm Exams: 20 points total (10 points each)**

  - Midterm Exam 01 is a 50-minute (student's section's class start and end time) in-person exam (March 12). It contains conceptual and applied problems. 
  - Midterm Exam 02 is a 50-minute (student's section's class start and end time) in-person exam (April 23). It contains conceptual and applied problems.
